                    ...
                    <div className="m-dropdown__body">
                        <div className="m-dropdown__content">
                            <ul className="m-nav m-nav--skin-light">
                                ...
                                <li className="m-nav__item" onClick={() => {this._logOut('en')}}>
                                    <a className="btn m-btn--pill    btn-secondary m-btn m-btn--custom m-btn--label-brand m-btn--bolder">{this.props.t('logout','Logout')}</a>
                                </li>
                            </ul>
                        </div>
                    </div>
