        ...
        return (<div className="row">
            ...
            {parent.accepted &&
                ...
                {!parent.accepted && <TabContainer>
                    <div className={`alert alert-${(parent.rejected ? 'danger' : 'success')}`}>
                        <p className='margin-0'>
                            {t(parent.rejected ? 'parentRejectedYourRequest' : 'youSentRequestToParent')}                                
                        </p>
                    </div>
                    <div className="m-widget1 m-widget1--paddingless">
                        <div className="m-widget1__item">
                        ...
                        <div className="m-widget1__item">
                            <div className="row m-row--no-padding">
                                <div className="col">
                                    <h3 className="m-widget1__title">{t('rejectedAt')}</h3>
                                </div>
                                <div className="col m--align-right">
