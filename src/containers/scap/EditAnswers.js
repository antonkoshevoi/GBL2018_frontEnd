                    ...
                    <div className='m-portlet__body'>
                        <div className="row">
                            ...
                            <div className="col-sm-12 m--margin-top-40 text-center">
                                <Button disabled={updateAnswersRequest.get('loading')} onClick={() => { this._saveAnswers(0) }} variant="raised" color='primary' className='mt-btn mt-btn-success m--margin-right-15'>
                                    {t('saveAndPublish')}
                                    <Icon className="m--margin-left-5">check</Icon>
                                </Button>
                                <Button disabled={updateAnswersRequest.get('loading')} onClick={() => { this._saveAnswers(1) }} variant="raised" color='primary' className='mt-btn mt-btn-success m--margin-right-15'>
                                    {t('saveAsDraft')}
                                    <Icon className="m--margin-left-5">check</Icon>
                                </Button>                                 
                                <Button disabled={updateAnswersRequest.get('loading')} onClick={() => { this._goBack() }} variant="raised" color='default' className='mt-btn mt-btn-cancel'>
                                    {t('cancel')}                                    
                                </Button>                                
                            </div>                              
                        </div>                        
