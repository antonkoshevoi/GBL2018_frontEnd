export default {
    ...
    loginToSeeYourTransactions: 'To your transaction please log in',
    ...
    youSentRequestToParent: 'You successfully sent request to this user. Please wait while your request will be accepted...',
